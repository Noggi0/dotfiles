...
local fonts = {
	wezterm.font("MonoLisa Nerd Font Medium"),
...
wezterm.on("switch-font", function(window, pane)
	...
	window:toast_notification("Font Switched", "Now using index" .. current_font_index, nil, 4000)
end)
...
config.keys = {
	...
	},
	{
		key = "f",
		mods = "CTRL",
		action = wezterm.action.EmitEvent("switch-font"),
	},
}
